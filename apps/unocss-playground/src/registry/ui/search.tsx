...
export const SearchControl = <T extends ValidComponent = "div">(
  ...
  return (
    <SearchPrimitive.Control
      ...
      class={cx(
        "dark:bg-input/30 border-input shadow-xs flex h-9 w-full rounded-md border bg-transparent px-3 py-1 text-base transition-[color,box-shadow] md:text-sm",
...
export const SearchContent = <T extends ValidComponent = "div">(
  ...
  return (
    <SearchPrimitive.Content
      ...
      class={cx(
        "bg-popover text-popover-foreground origin-(--kb-search-content-transform-origin) relative z-50 min-w-[8rem] overflow-y-auto overflow-x-hidden rounded-md border shadow-md",
