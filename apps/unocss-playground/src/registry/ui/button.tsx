...
export const buttonVariants = cva({
  ...
  variants: {
    variant: {
      ...
      destructive:
        "bg-destructive text-white hover:bg-destructive/90 focus-visible:(ring-destructive/20 dark:ring-destructive/40) dark:bg-destructive/60",
      outline:
        "border bg-background shadow-xs hover:(bg-accent text-accent-foreground dark:bg-input/50) dark:bg-input/30 dark:border-input",
      secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80",
      ghost: "hover:(bg-accent text-accent-foreground dark:bg-accent/50)",
