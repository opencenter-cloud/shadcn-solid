  ...
  return (
    <>
      <DrawerPrimitive.Overlay
        ...
        class="fixed inset-0 z-50 bg-black/50 data-[transitioning]:(transition-colors duration-500 ease-[cubic-bezier(0.32,0.72,0,1)])"
        style={{
      ...
      <DrawerPrimitive.Content
        ...
        class={cx(
          ...
          "after:(absolute bg-inherit)",
          "data-[transitioning]:(transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)])",
          context.side() === "bottom" && [
