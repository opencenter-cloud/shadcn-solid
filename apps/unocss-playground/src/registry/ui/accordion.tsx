  ...
  return (
    <AccordionPrimitive.Header class="flex">
      <AccordionPrimitive.Trigger
        ...
        class={cx(
          "flex flex-1 items-start justify-between gap-4 rounded-md py-4 text-left text-sm font-medium outline-none transition-all hover:underline [&[data-expanded]>svg]:rotate-180",
