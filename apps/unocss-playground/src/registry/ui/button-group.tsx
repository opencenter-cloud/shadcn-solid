...
export const buttonGroupVariants = cva({
  ...
  variants: {
    orientation: {
      horizontal:
        "[&>*:not(:first-child)]:(rounded-l-none border-l-0) [&>*:not(:last-child)]:rounded-r-none",
      vertical:
        "flex-col [&>*:not(:first-child)]:(rounded-t-none border-t-0) [&>*:not(:last-child)]:rounded-b-none",
    },
  },
  defaultVariants: {
