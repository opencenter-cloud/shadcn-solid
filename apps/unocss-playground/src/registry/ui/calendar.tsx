...
export const CalendarCell = <T extends ValidComponent = "td">(
  ...
  return (
    <CalendarPrimitive.Cell
      ...
      class={cx(
        "relative p-0 text-center text-sm has-[[data-range-end]]:rounded-r-md has-[[data-range-start]]:rounded-l-md has-[[data-disabled][data-selected]]:opacity-50",
        "has-[[data-in-range]]:(bg-accent first:rounded-l-md last:rounded-r-md)",
    ...
    <CalendarPrimitive.CellTrigger
      ...
      class={buttonVariants({
        ...
        class: [
          ...
          "data-[today]:(bg-accent text-accent-foreground dark:focus-visible:ring-secondary)",
          "aria-selected:not-[[data-in-range]]:(bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground)",
          "data-[range-start]:aria-selected:(bg-primary text-primary-foreground hover:bg-primary! hover:text-primary-foreground!)",
          "data-[range-end]:aria-selected:(bg-primary text-primary-foreground hover:bg-primary! hover:text-primary-foreground!)",
          props.class,
        ],
      })}
      {...rest}
