...
export const FileField = <T extends ValidComponent = "div">(
  ...
  return (
    <FileFieldPrimitive
      ...
      class={cx(
        "group/file_field flex size-full flex-col items-center justify-center gap-2",
        props.class,
      )}
      {...rest}
    />
...
export const FileFieldDropzone = <T extends ValidComponent = "div">(
  ...
  return (
    <FileFieldPrimitive.Dropzone
      ...
      class={cx(
        "text-muted-foreground flex size-full min-h-[200px] flex-col items-center justify-center gap-2 rounded-lg border border-dashed outline-none transition-[color,box-shadow]",
        "focus-visible:(border-ring ring-ring/50 ring-[3px])",
        "disabled:(pointer-events-none cursor-not-allowed opacity-50)",
        "group-[[data-invalid]]/file_field:(ring-destructive/20 dark:ring-destructive/40 border-destructive)",
        props.class,
      )}
      {...rest}
    />
...
export const FileFieldItemDeleteTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <FileFieldPrimitive.ItemDeleteTrigger
      ...
      class={cx(
        "cursor-pointer self-center rounded-sm p-0.5 outline-none transition-[color,box-shadow] [grid-area:delete] [&_svg:not([class*=size-])]:size-4",
        "focus-visible:(ring-destructive/50 ring-[1.5px])",
        props.class,
      )}
      {...rest}
    >
