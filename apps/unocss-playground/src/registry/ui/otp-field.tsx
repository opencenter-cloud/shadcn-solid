...
export const OTPFieldSlot = (props: OTPFieldSlotProps) => {
  ...
  return (
    <div
      ...
      class={cx(
        "dark:bg-input/30 border-input shadow-xs relative flex h-9 w-9 items-center justify-center border-y border-r text-sm outline-none transition-all last:rounded-r-md",
        "data-[active=true]:(border-ring ring-ring/50 z-10 ring-[3px] aria-[invalid]:(ring-destructive/20 dark:ring-destructive/40 border-destructive border-destructive))",
