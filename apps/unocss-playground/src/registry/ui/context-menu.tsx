...
export const ContextMenuItem = <T extends ValidComponent = "div">(
  ...
  return (
    <ContextMenuPrimitive.Item
      ...
      class={cx(
        "[&>*:is(svg)]:data-[variant=destructive]:!text-destructive [&_svg:not([class*=text-])]:text-muted-foreground outline-hidden relative flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm data-[inset]:pl-8 [&_svg:not([class*=size-])]:size-4",
        "data-[highlighted]:(bg-accent text-accent-foreground)",
        "data-[variant=destructive]:(text-destructive data-[highlighted]:(bg-destructive/10 text-destructive dark:bg-destructive/20))",
        "[&_svg]:(pointer-events-none shrink-0)",
